...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form action="addAnimal" method="post" class="form-horizontal">
		  ...
		  <!--  
		 <div class="form-group">
		    <label for="scheduleID" class="col-sm-4 control-label">Feeding Schedule</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="feedingSchedule" name="Feeding Schedule" placeholder="scheduleID" required="required"/>
		    </div>
		  </div>
		  -->
		  <div class="form-group">
